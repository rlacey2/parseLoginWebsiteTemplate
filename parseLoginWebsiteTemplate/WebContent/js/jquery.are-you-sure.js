...
(function($) {
  $.fn.areYouSure = function(options) {
    ...
    if (!settings.silent) {
     ...
     // this is doing the assiging of the events to the form element (ONLY) 
    return this.each(function(elem) {
      ...
      $form.submit(function() {                   // if trapping externally, this will not be triggered hence handle outside
